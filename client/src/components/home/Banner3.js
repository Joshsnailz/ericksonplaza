        ...
        <article className="flex flex-col justify-start items-end order-1">
          <div className="flex flex-col gap-y-4 max-w-lg z-50 lg:mr-auto lg:mr-0 mr-auto">
            <h1 className="md:text-6xl text-4xl">
              Save a great deal of money with Erickson Plaza deliveries
            </h1>
            <p className="flex flex-row gap-x-0.5 items-center text-lg text-slate-500">
              With our cheap all around town deliveries, you can cut costs on
              logistics and all the nitty gritty details of the hustles that
              coming with transportation of goods.
            </p>
            <button
